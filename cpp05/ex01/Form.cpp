...
/*   Updated: 2022/01/18 17:21:54 by tefroiss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (gr_exec < 1 || gr_sign < 1)
		throw GradeTooHighException("Grade recommand to sign the Form is too HIGH in comparison with the max grade of Bureaucrat.");
	if (gr_exec > 150 || gr_sign > 150)
		throw GradeTooLowException("Grade recommand to sign the Form is too LOW in comparison with the max grade of Bureaucrat.");
	if (signature == true)
		_signed = false;
}
...
void Form::setSign(bool Signed) { this->_signed = Signed; }
